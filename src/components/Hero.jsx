...
export default function Hero() {
    return (
        <header style={{ backgroundImage: `url(${bannerImage})` }} className="bg-hero-pattern bg-cover bg-center bg-no-repeat w-10/12 mx-auto h-[80vh]">

            <div className='h-full flex justify-center items-center bg-[#00000090] bg-opacity-50'>
